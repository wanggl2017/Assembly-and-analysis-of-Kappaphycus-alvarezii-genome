...
##
  $REPEATMASKER_DIR = "/disk10/biosoft/RepeatMasker";
...
##
  $RMBLAST_DIR      = "/usr/local/rmblast-2.2.28/bin";
...
##
  $RECON_DIR = "/disk10/biosoft/RECON-1.08/bin";
...
##
  $RSCOUT_DIR = "/disk10/biosoft/RepeatScout-1";
